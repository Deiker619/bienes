        ...
        <div class="col-xl-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-description"></label class="d-flex justify-content-center align-items-center"> Total de artificios: <label class="badge badge-info"></label> </div>
                                    ...
                                    <td>
                                        ...
                                        <span class="dropdown dropleft d-block">
                                            ...
                                            <span class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                <a class="dropdown-item" wire:click="edit({{$coordinacion->id}})" style="cursor: pointer">Editar</a>
                                                <a class="dropdown-item" wire:click="delete({{$coordinacion->id}})" style="cursor: pointer">Eliminar</a>
                                            </span>
                                        </span>
                            ...
                            <form class="forms-sample">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" wire:model="name_coordinacion" id="exampleInputUsername1" placeholder="Ej: coordinacion de Anzoategui">
