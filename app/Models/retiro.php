...
{
    use HasFactory;
    protected $fillable = ['observacion','cedula_tercero', 'nombre_tercero' ,'lugar_destino', 'beneficiario_id','jornada_id', 'ente_id','nombre_entrega','cedula_entrega','is_reserva','scheduled_at'];
